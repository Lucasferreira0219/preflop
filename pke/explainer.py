...
def build_decision(ctx: HandContext, rec: Recommendation, hero_action: str,
    ...
    return {
        ...
        "qualidade_linha": score.get("hero_action_quality"),
        "nota_pedagogica": score.get("quality_note"),
        "acoes_aceitaveis": score.get("acceptable_actions") or [],
        "alternativas_avancadas": score.get("advanced_alternatives") or [],
        "acoes_ruins": score.get("bad_actions") or [],
        "erros_graves_acoes": score.get("severe_mistakes") or [],
